...
\foreach \days in {0, 7, ..., 364}{
    ...
    \calendar(myweek)[
        day list downward,
        mymonth label,
        month text={{\sffamily\bfseries \Huge \%mt}},
        day text={\ifdate{Saturday}{\%d=/}{\hypertarget{\pgfcalendarsuggestedname}{\hyperlink{month\DTMfetchmonth{CurrDate}-\%y0-\%m0-\%d0}{\%d=}}}},
        month yshift = 0pt,
        day yshift = 6cm,
        execute at begin day scope=
        {
            ...
            \ifdate{Sunday}{\pgftransformyshift{24cm}\pgftransformxshift{8.65cm}}{}
        },
